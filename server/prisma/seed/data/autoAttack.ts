...
export const autoAttackSeedData: AutoAttackSeed[] = [
    {
        ...
        description: "Đánh 1 mục tiêu thấp máu nhất bằng 135% AD. Có 30% cơ hội áp dụng hiệu ứng giảm 10% DEF lên đối phương trong 2 lượt.",
        damage: 135,
    ...
    },
    {
        ...
        description: "Đánh 1 mục tiêu gần nhất bằng 135% AD, sau đó gây thêm 30% sát thương lan lên 1 kẻ địch gần nhất.",
        damage: 135,
        attack_type: EAttackType.Physical,
    ...
    },
    {
        ...
        description: "Đánh ngẫu nhiên 1 mục tiêu bằng 135% AP và hồi cho đồng minh có % HP thấp nhất một lượng bằng 20% sát thương gây ra.",
        damage: 135,
    ...
    },
    {
        ...
        description: "Đánh 2 mục tiêu gần nhất bằng 100% AP, 25% cơ hội thiêu đốt 2 mục tiêu trong 1 lượt (gây sát thương bằng 15% tổng sát thương của đòn đánh).",
        damage: 100,
        attack_type: EAttackType.Magical,
        attack_position: ETargetPosition.Nearest,
        target_count: 2
    },
    {
        ...
        description: "Đánh ngẫu nhiên 1 mục tiêu bằng 135% AP và có 25% cơ hội gây câm lặng lên đối phương trong 1 lượt.",
        damage: 135,
        attack_type: EAttackType.Magical,
        attack_position: ETargetPosition.Random,
        target_count: 1
